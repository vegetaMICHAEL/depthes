...
import sys
sys.path.append('/home/lmolhw/workspace/UniFuse-Unidirectional-Fusion')
...
class DeepLabv3_plus(nn.Module):
    ...
    def call_modality(self, method, *feed_args, **feed_kwargs):
        ...
        output_dict = {}
        curr_dict = compute_total_losses(*feed_args, **feed_kwargs)
    ...
    def compute_losses(self, input):
        ...
        losses = self.call_modality('compute_losses', feat, input)
...
def compute_total_losses(pred, batch):
        gt = batch['depth']
        mask = (gt > 0)
