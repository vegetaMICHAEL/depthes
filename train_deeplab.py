...
'''Deeplab_MAGCA'''
# from deeplab_trainer import Trainer
'''VAE_Deeplab'''
from vae_deeplab_trainer import Trainer
...
parser.add_argument("--ehc", type=bool, default=False)
parser.add_argument("--vae", type=bool, default=False)
parser.add_argument("--distribution", type=str, default='normal')
parser.add_argument("--pretrained", type=bool, default=False)

args = parser.parse_args()
args.data_path = '/test/depth/data/'
args.dataset = '3d60'#'stanford2d3d'  # 3d60
args.batch_size = 20
args.height = 512
args.width = 1024
args.net = 'deeplab_sitanfu'
# args.ehc = True
args.vae = True
args.distribution = 'normal'
args.pretrained = True
args.freeze_ASPP = True
args.log_dir = 'Logs/{}_{}'.format(args.dataset, args.net)
args.load_weights_dir = 'model90'
