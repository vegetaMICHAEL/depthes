...
if __name__ == "__main__":
    ...
    args.m3d_path = '/test/depth/data/Matterport3D'
    args.s2d3d_path = '/test/depth/data/Stanford2D3D'
    args.suncg_path = '/test/depth/data/SunCG'
    args.outliers_path = '/test/depth/data/output'
    splits = list()
    ''' Matterport3D '''
    if 'm3d_path' in args:
