...
settings.dataset = '3d60'
#'stanford2d3d' #stanford2d3d
settings.ehc = False
settings.vae = True
settings.distribution = 'normal'
settings.save_samples = False
#settings.load_weights_dir = '/data1/lhw/workspace/UniFuse-Unidirectional-Fusion/UniFuse/Logs/stanford2d3d_deeplab_MAGCA_VAE_Normal/panodepth/models/weights_8'
settings.load_weights_dir = 'Logs/3d60_concat_0.001/panodepth/models/weights_0'
