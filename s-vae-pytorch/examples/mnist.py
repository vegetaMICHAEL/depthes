...
train_loader = torch.utils.data.DataLoader(datasets.MNIST('/data1/lhw/workspace/UniFuse-Unidirectional-Fusion/UniFuse/s-vae-pytorch/examples/data', train=True, download=True,
    transform=transforms.ToTensor()), batch_size=64, shuffle=True)
test_loader = torch.utils.data.DataLoader(datasets.MNIST('/data1/lhw/workspace/UniFuse-Unidirectional-Fusion/UniFuse/s-vae-pytorch/examples/data', train=False, download=True,
